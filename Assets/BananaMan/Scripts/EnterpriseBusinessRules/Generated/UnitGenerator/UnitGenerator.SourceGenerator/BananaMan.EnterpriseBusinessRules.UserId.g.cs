...
namespace BananaMan.EnterpriseBusinessRules
{
    ...
    readonly partial struct UserId 
        ...
        , IEqualityOperators<UserId, UserId, bool>
#endif
    {
        readonly int value;
        ...
        private class UserIdJsonConverter : JsonConverter<UserId>
        {
            ...
            public override UserId Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                ...
                if (converter != null)
                {
                    return new UserId(converter.Read(ref reader, typeToConvert, options));
                }
                else
                {
                    throw new JsonException($"{typeof(int)} converter does not found.");
        ...
        {
            private static readonly Type WrapperType = typeof(UserId);
            ...
            {
                if (value is UserId wrappedValue)
                {
